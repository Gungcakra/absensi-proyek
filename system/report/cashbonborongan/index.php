...
<body class="  ">
                                ...
                                <div class="row justify-content-between">
                                        ...
                                        <div id="user_list_datatable_info" class="dataTables_filter">
                                            ...
                                            <form class="mr-3 position-relative d-flex ">
                                                ...
                                                <div class="input-group col">
                                                    <input type="month" class="form-control bg-white" name="bulanTahun" id="bulanTahun" onchange    ="cariDaftarCashbon()">
                                                </div>
                                                <div class="col p-0 m-0">
                                                    <select class="custom-select" id="idProyek" name="idProyek" onchange="cariDaftarCashbon()">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="user-list-files d-flex justify-content-end">
                                            ...
                                            <a class="btn btn-success mr-1 text-white font-weight-bold" onclick="generateLaporan()"> <i class="las la-file-pdf"></i> Laporan</a>

                                        </div>
                                    </div>
                                </div>
                                <div id="daftarCashbon" class="w-100" style="overflow:scroll">
    ...
    <script src="<?= BASE_URL_HTML ?>/system/report/cashbonborongan/cashbon.js"></script>
