...
<body class="  ">
                                        ...
                                        <div id="user_list_datatable_info" class="dataTables_filter">
                                            ...
                                            <form class="mr-3 position-relative d-flex ">
                                                ...
                                                <div class="col p-0 m-0">
                                                    <select class="form-control select-tukang pb-2" id="idTukang" name="idTukang" onchange="cariDaftarAbsensi()">
    ...
    <script src="<?= BASE_URL_HTML ?>/system/report/absensipertukang/absensi.js"></script>
