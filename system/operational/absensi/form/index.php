            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 bg-white p-2">
                        <form id="formAbsensiInput">
                            <div class="form-row">
                                <input type="hidden" name="flagAbsensi" id="flagAbsensi" value="<?= $flagAbsensi ?>">
                                ...
                                <div class="col-md-6 d-flex flex-column">
                                    ...
                                    <input type="text" class="form-control" id="longitude" name="longitude" value="<?= $data['longitude'] ?? '' ?>" autocomplete="off" placeholder="Longitude">
                                </div>
                                <div class="col-md-6 d-flex flex-column">
                                    <label for="latitude">Latitude</label>
                                    <input type="text" class="form-control" id="latitude" name="latitude" value="<?= $data['latitude'] ?? '' ?>" autocomplete="off" placeholder="Latitude">
                                </div>
                                <div class="col-md-6 d-flex flex-column">
                                    <label for="radius">Radius</label>
                                    <input type="text" class="form-control" id="radius" name="radius" value="<?= $data['radius'] ?? '' ?>" autocomplete="off" placeholder="Radius">
                                </div>
                            </div>
                        </form>

                        <button type="button" class="btn btn-<?= $flagAbsensi === 'add' ? 'update' : 'info' ?> btn-primary m-1 mt-3" onclick="prosesAbsensi()"><i class="ri-save-3-line"></i>Simpan</button>
                    </div>
                </div>
            </div>
        </div>
