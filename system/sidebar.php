...
',
            ...
            'submenu' => [
                [
                    'title' => 'Tukang',
                    'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>',
                    'url' => BASE_URL_HTML . '/system/data/borongan/tukang/',
                    'active' => $_SERVER['REQUEST_URI'] == BASE_URL_HTML . '/system/data/borongan/tukang/'
                ],
                [
                    'title' => 'Cash Bon',
                    'icon' => '<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
',
                    'url' => BASE_URL_HTML . '/system/data/borongan/cashbon/',
                    'active' => $_SERVER['REQUEST_URI'] == BASE_URL_HTML . '/system/data/borongan/cashbon/'
                ],
            ]
        ],
        [
...
',
                    'url' => BASE_URL_HTML . '/system/report/absentukang/',
                    'active' => $_SERVER['REQUEST_URI'] == BASE_URL_HTML . '/system/report/absentukang/'
                ],
                [
                    'title' => 'Cash Bon',
                    'icon' => '<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
',
                    'url' => BASE_URL_HTML . '/system/report/cashbon/',
                    'active' => $_SERVER['REQUEST_URI'] == BASE_URL_HTML . '/system/report/cashbon/'
                ],
                [
                    'title' => 'Borongan',
                    'icon' => '<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
',
                    'url' => BASE_URL_HTML . '/system/report/cashbonborongan/',
                    'active' => $_SERVER['REQUEST_URI'] == BASE_URL_HTML . '/system/report/cashbonborongan/'
                ],
    ...
    <div class="iq-sidebar sidebar-default">
        <div class="iq-sidebar-logo d-flex align-items-center">
            <a href="<?= BASE_URL_HTML ?>/system/" class="header-logo">
                <img src="<?= BASE_URL_HTML ?>/assets/images/logo.png" alt="logo">
